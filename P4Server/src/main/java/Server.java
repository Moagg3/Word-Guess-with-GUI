...
public class Server{
    ...
    void             Start( )                                     {CT_Collector.start( );}

    // Returns the ListView specific to the Server class
    ListView<String> Get_ServerDisplayList( )                     {return ServerListView;}

    // Returns the ListView specific to the ClientThread; (Acquired using a key)
    ListView<String> Get_ClientThread_DisplayList(Integer ht_key) {return HT_ClientThread.get(ht_key).CT.DisplayListItems;}

    // Determines if the Client Thread is an active one based on the provided key
    Boolean  ClientThread_IsActive(Integer key) {
    ...
    public class ClientThread extends Thread{
        ...
        ClientThread(Socket _acceptedSocket, Integer _threadCounter){
        ...
        public void ResetCategories( ){
            ...
            for(String key: setOfKeys){
                ...
                HT_NodeCategories.get(key).numTriesLeft = 3;
            }
        }
